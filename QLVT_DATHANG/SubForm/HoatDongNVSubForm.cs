...
{
    public partial class HoatDongNVSubForm : Form
    {
        ...
        {
            HDNVPicker hDNVPicker = new HDNVPicker();
            hDNVPicker.Show();
            Program.hoatDongNVSubForm.Enabled = false;
        }

        private void HoatDongNVSubForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            String query = "EXEC SP_InfoNV " + tbMANV.Text;
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Xrpt_HoatDongNV reportHoatDongNhanVien = new Xrpt_HoatDongNV(manv, deStart.DateTime, deEnd.DateTime, role);
